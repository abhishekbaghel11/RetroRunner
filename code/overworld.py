...
class Overworld:
    def __init__(self,start_level,max_level,surface,create_level):
        ...
        self.background_image = pygame.image.load('../graphics/overworld/bg_1.jpg')
    ...
    def draw_paths(self):
        if self.max_level > 0:
            ...
            pygame.draw.lines(self.display_surface,'#9005fa',False,points,6)
    ...
    def input(self):
        ...
        if not self.moving:
            if (keys[pygame.K_RIGHT] or keys[pygame.K_DOWN]) and self.current_level < self.max_level:
                self.move_direction = self.get_movement_data('next')
                self.current_level += 1
                self.moving = True
            elif (keys[pygame.K_LEFT] or keys[pygame.K_UP]) and self.current_level > 0:
    ...
    def run(self):
        ...
        self.draw_paths() #keep below the bg 
